...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  var responseHeadersHandler = req.corsAnywhereRequestState.responseHeadersHandler;
  ...
  if(typeof responseHeadersHandler == 'function') {
    responseHeadersHandler(proxyRes.headers, req);
  }
...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    getRequestUrl: null,            // custom request url logic
    setHeaders: {},                 // Set these request headers.
    responseHeadersHandler: null,   // reponse headers handler
  ...
  return function(req, res) {
    req.corsAnywhereRequestState = {
      ...
      responseHeadersHandler: corsAnywhere.responseHeadersHandler
    };
    ...
    // console.log('corsAnywhere:', corsAnywhere);
    if(typeof corsAnywhere.getRequestUrl == 'function') {
      location = parseURL(corsAnywhere.getRequestUrl(req));
    }
    // console.log('location:', location);
